...
<body>
	<header id="header">
		<?php require("nav_bs.php")  ?>
	</header>

	<section id="presentac">
		<div id="fotos_entrada">
			<div class="sty_img_box" id="img1"><img class="img_pres" src="imgs/img1.png"></div>
			<div class="sty_img_box" id="img2"><img class="img_pres" src="imgs/img2.png"></div>
		</div>
		<div id="txt_present">
	...
	<section id="servicios"><h2>Servicios</h2>
		<div>
			<div><h3>Departamentos</h3></div>
			<div id="deps" class="img_servicios"></div>
		</div>
		<div>
			<div><h3>Cocheras</h3></div>
			<div id="cochs" class="img_servicios"></div>
		</div>
		<div>
			<div><h3>Locales</h3></div>
			<div id="local" class="img_servicios"></div>
		</div>
	</section>

	<section id="ubicacion"><h2>Donde estamos</h2>
		<div id="mapa"><h3>En el mapa:</h3>
				<iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d751.2736935507031!2d-71.30049831189172!3d-41.1324569885912!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x961a7b70728b2a4f%3A0x660120e62d69e254!2s12%20de%20Octubre%20665%2C%20San%20Carlos%20de%20Bariloche%2C%20R%C3%ADo%20Negro!5e0!3m2!1ses-419!2sar!4v1630955143227!5m2!1ses-419!2sar" width="600" height="400" style="border:0;" allowfullscreen="" loading="lazy"></iframe>
			</div>
		<div id="distancias">
			<div><h2>Distancias cercanas</h2></div>
			<?php require("accordion_dist.php");?>
 		</div>
	</section>
